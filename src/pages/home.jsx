            ...
            <section className="bg-white dark:bg-gray-900 flex items-center md:h-screen md:px-12">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7 order-2 md:order-1">
                        ...
                        <p className="max-w-lg mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-sm dark:text-gray-400 text-xs text-center md:text-left">Our cloud-based Collaboration tool streamlines the design process for interior designers. Collaborate seamlessly with clients, share ideas, and make decisions in real-time.</p>
                        ...
                        <form class="max-w-md">
                            ...
                            <div class="relative">
                                ...
                                <button type="submit" class="text-white absolute end-2.5 bottom-1.5 bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-4 py-2 dark:bg-dark-800 dark:hover:bg-dark-900 dark:focus:ring-blue-800">Start Collaborations</button>
                            </div>
                        </form>
                    ...
                    <div className="lg:mt-0 lg:col-span-5 lg:flex order-1 md:order-2 " >
                        <img src={imgOne} alt="mockup" className="w-full p-8 md:p-0 breathing-image" />
                    </div>
                </div>
            </section>
        </>
