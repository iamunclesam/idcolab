                    ...
                    <div className="mr-auto place-self-center lg:col-span-7 order-2 md:order-1">
                        ...
                        <form class="max-w-md">
                            ...
                            <div class="relative">
                                ...
                                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-dark-800 dark:hover:bg-dark-900 dark:focus:ring-blue-800">Start Collaborations</button>
                            </div>
                        </form>
