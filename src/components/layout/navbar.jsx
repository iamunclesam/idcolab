...
const Navbar = () => {
  ...
  return (
    <nav className="z-[200] fixed top-0 w-full mb-10 px-3 lg:px-6 bg-white dark:bg-gray-900">
      <div
        className={`bg-white ${
          theme === "dark" ? "dark:bg-gray-800" : ""
        } z-[200] max-w-screen-xl flex items-center justify-between border border-white dark:border-gray-800 shadow-md shadow-slate-400 dark:shadow-none rounded-full my-4 px-4 mx-auto py-2 lg:text-xs`}
      >
        <div className="flex flex-row w-[70%] xl:w-[75%] gap-5 xl:gap-12">
          <a href="/">
            <svg
              className="w-20 md:w-40 ml-4 dark:fill-white"
              viewBox="0 0 226 64"
              fill="none"
          ...
          <ul className="hidden lg:flex justify-center items-center ml-6 gap-6 xl:gap-10 font-semibold dark:text-gray-300">
        ...
        <div className="flex gap-5 xl:gap-10 items-center justify-end">
          <ul className="flex justify-between items-center gap-6 xl:gap-10 font-semibold dark:text-gray-300">
            ...
            <li className="hover:text-[#FECB03] align-middle hidden lg:flex">
          ...
          <button className="border border-[#6628c6] hover:border-[#6366F1] px-3 py-2 text-sm rounded-lg text-center items-center bg-[#6628c6] hover:bg-[#6366F1] text-white hidden lg:flex font-semibold">
            <a href="">SIGN UP</a>
          </button>
        </div>
      ...
      {menuOpen && (
        <div
          ...
          } w-72 h-72 shadow-md shadow-slate-400 dark:shadow-none border border-gray-300 rounded-lg pb-8 mb-5 mx-4 float-right text-gray-500`}
        >
